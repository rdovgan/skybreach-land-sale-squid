module.exports = class Data1657672215499 {
  name = 'Data1657672215499'

  async up(db) {
    await db.query(`CREATE TABLE "land_sale" ("id" character varying NOT NULL, "buyer" text NOT NULL, "seller" text NOT NULL, "price" numeric NOT NULL, "referrer" text NOT NULL, "bought_with_credits" boolean NOT NULL, "txn_hash" text NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, "plot_id" character varying NOT NULL, CONSTRAINT "PK_988cc5b7edf47a7090638f4ca5a" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "plot_offer" ("id" character varying NOT NULL, "buyer" text NOT NULL, "txn_hash" text NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, "price" numeric NOT NULL, "plot_id" character varying NOT NULL, CONSTRAINT "PK_cf11fd862d08df1f95e7598de78" PRIMARY KEY ("id"))`)
