module.exports = class Data1657895355448 {
  name = 'Data1657895355448'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "plot" ("id" character varying NOT NULL, "owner" text NOT NULL, "price" numeric NOT NULL, CONSTRAINT "PK_7c22bdc3280a3a5610c63159883" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_1702fa1d2c5e53abe8ce06c119" ON "plot" ("owner") `)
    await db.query(`CREATE TABLE "plot_offer" ("id" character varying NOT NULL, "buyer" text NOT NULL, "txn_hash" text NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "price" numeric NOT NULL, "parent_plot_id" text NOT NULL, "plot_id" character varying NOT NULL, CONSTRAINT "PK_cf11fd862d08df1f95e7598de78" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE INDEX "IDX_da8a5ee8d8a40bfe4d95605c7c" ON "plot_offer" ("parent_plot_id") `)
  ...
  async down(db) {
    ...
    await db.query(`DROP INDEX "public"."IDX_da8a5ee8d8a40bfe4d95605c7c"`)
